"""
Single-Point_Energy_Analyzer_2.8
...
Oscillar Strength for n states
...
2.8 fixes a bug where largest_nstates only compared the nstates values for the previous two files. Now the script
finds largest_nstates of all the files.
...
# gets the excited state energies in eV and nm and corresponding oscilator strengths from the output file
...
for file_name in file_paths:
    ...
    if mo_nstates!=None:
        ...
        if 'largest_nstates' not in locals() or nstates>largest_nstates:
